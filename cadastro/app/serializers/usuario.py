    ...
    def update(self, instance, validated_data):
        ...
        if 'endereco' in validated_data:
            ...
            if instance.endereco:
                ...
                instance.endereco.estado = endereco_data.get('estado', instance.endereco.estado)
                instance.endereco.municipio = endereco_data.get('municipio', instance.endereco.municipio)
                instance.endereco.cep = endereco_data.get('cep', instance.endereco.cep)
                instance.endereco.rua = endereco_data.get('rua', instance.endereco.rua)
                instance.endereco.numero = endereco_data.get('numero', instance.endereco.numero)
                instance.endereco.complemento = endereco_data.get('complemento', instance.endereco.complemento)
